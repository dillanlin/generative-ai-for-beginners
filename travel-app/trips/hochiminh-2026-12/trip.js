...
window.TRIP_DATA = {
  meta: {
    ...
    rev: 3,                        // ★ 改完這個檔案就把 rev 加一號，手機重開才會吃到新版
    title: '胡志明市 5天4夜',
  ...
  car: {
    title: '交通 · 住宿',
    rows: [
      ['住宿', '第一郡「濱城市場 ↔ 阮惠」走廊（訂好後補名稱）'],
      ['選這區的理由', '你的第一郡停點排成一條線，住走廊上任一點全部 12 分鐘內走得到'],
      ['入住 / 退房', '12/1 約 16:30 入住 · 12/5 12:00 退房後行李寄櫃檯'],
  ...
  days: [
    {
      ...
      items: [
        ...
        { id: 'hcm1-3', time: '16:30', cat: '住宿', title: '第一郡飯店 Check-in', subtitle: '濱城市場 ↔ 阮惠走廊（飯店訂好後補名稱）',
          lat: 10.7735, lng: 106.6990,
          meta: [{ icon: 'car', text: '📱 Grab · 機場約 30–45 分／150,000–250,000 VND' }],
          tip: '⚠️ 今天只放行李、不整理，17:00 一定要出門去市場 —— 奧黛是這趟唯一有時間鏈的事' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'hcm2-8', time: '17:00', cat: '交通', title: '★ 捷運一號線初體驗', subtitle: 'Nhà hát Thành phố（歌劇院站）→ Tân Cảng',
          lat: 10.7770, lng: 106.7020,
          meta: [{ icon: 'car', text: '🚈 捷運 · 約 10 分鐘' }, { icon: 'ticket', text: '一日券 40,000 VND 吃到飽' }],
          tip: '2024/12 才通車的新捷運，冷氣強、不塞車，比 Grab 舒服。進站感應、出站單程票要投回收口' },
        { id: 'hcm2-9', time: '17:30', cat: '景點', title: 'Landmark 81 觀景台', subtitle: '越南最高樓 461m · 看日落轉夜景',
          lat: 10.7950, lng: 106.7218,
          meta: [{ icon: 'walk', text: '🚶 Tân Cảng 站走路 8 分' }, { icon: 'ticket', text: '約 300,000 VND' }, { icon: 'clock', text: '日落約 17:30' }],
          tip: '⭐ 抓在日落前上去，一次看到白天和夜景。想省門票的話，直接上樓上的酒吧點一杯，view 一樣' },
        { id: 'hcm2-10', time: '19:00', cat: '咖啡', title: 'nham.coffee 花咖', subtitle: '195/10/2 Điện Biên Phủ · 24 小時',
          lat: 10.7995, lng: 106.7115,
          meta: [{ icon: 'car', text: '📱 Grab · Landmark 81 約 10 分' }, { icon: 'clock', text: '24 小時' }],
          photos: [{ src: 'photos/nham-coffee.jpg', caption: 'nham.coffee 花咖 · ⚠️ 花的佈置是季節性會換的；另有第十郡 Hoà Hưng 與 Thảo Điền 分店，長相完全不同，別走錯' }],
          tip: '⚠️ 認明「平盛郡 Điện Biên Phủ」這家才是花咖。24 小時營業，不用趕' },
        { id: 'hcm2-11', time: '20:30', cat: '晚餐', title: '晚餐 · 回市區', subtitle: '捷運 Tân Cảng → Bến Thành 或 Grab',
          lat: 10.7740, lng: 106.6990,
          meta: [{ icon: 'car', text: '🚈 捷運（末班 23:30）／📱 Grab' }],
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'hcm5-3', time: '10:30', cat: '咖啡', title: '最後的越式咖啡', subtitle: '阮惠或濱城周邊，補拍白天的街景',
          lat: 10.7745, lng: 106.7025,
          meta: [{ icon: 'walk', text: '🚶 走路 10 分' }],
          tip: '早上人少，前幾天拍不好的可以補拍' },
